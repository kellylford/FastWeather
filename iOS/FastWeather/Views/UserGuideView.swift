        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 24) {
                ...
                GuideSection(
                    ...
                    Text("**Understanding Spatial Precision:**")
                        .fontWeight(.semibold)
                        .padding(.top, 8)
                    Text("When VoiceOver is enabled and \"Show Offset Distance\" is on in settings, each city announces its distance from the center line. This helps you determine if a city is directly on your search path or offset to the side.")
                        .font(.callout)
                        .foregroundColor(.secondary)
                        .padding(.leading, 16)
                        .padding(.bottom, 4)
                    ...
                    BulletPoint("**\"X miles east/west of center line\"** - City is offset perpendicular to your search direction")
                    BulletPoint("**Example:** Searching north at 100 miles might show \"Madison, 95 miles, 2 miles east of center line\"")
                    ...
                    Text("**Weather Movement Detection:**")
                        .fontWeight(.semibold)
                        .padding(.top, 8)
                    Text("When \"Show Weather Movement\" is enabled in settings, VoiceOver announces whether weather systems are approaching, moving away, or moving parallel to your location. This uses wind direction data to analyze movement patterns.")
                        .font(.callout)
                        .foregroundColor(.secondary)
                        .padding(.leading, 16)
                        .padding(.bottom, 4)
                    ...
                    BulletPoint("**\"Calm\"** - Wind speed below 5 mph, minimal movement")
                    
                    Text("**Example VoiceOver Announcement:**")
                        .fontWeight(.semibold)
                        .padding(.top, 8)
                    Text("\"Milwaukee, Wisconsin, 80 miles, 3 miles east of center line, 75°F, Overcast, Approaching at 15 mph, 2 of 15\"")
                        .font(.callout)
                        .italic()
                    ...
                    Text("This tells you the city, distance, spatial offset, weather conditions, movement direction, and your position in the list.")
                        .font(.callout)
                        .foregroundColor(.secondary)
                        .padding(.leading, 16)
                        .padding(.bottom, 8)
                    ...
                    Text("**Configuring Weather Around Me:**")
                        .fontWeight(.semibold)
                        .padding(.top, 8)
                    Text("Go to Settings → Weather Around Me to customize:")
                        .font(.callout)
                        .foregroundColor(.secondary)
                        .padding(.leading, 16)
                        .padding(.bottom, 4)
                    ...
                    BulletPoint("**Show Offset Distance** - Toggle perpendicular distance announcements")
                    BulletPoint("**Show Weather Movement** - Toggle weather system movement detection")
